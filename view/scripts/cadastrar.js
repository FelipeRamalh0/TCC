...
const nivelCadastro = document.getElementById("nivelCadastro");

const camposProfissional = document.getElementById("camposProfissional");

nivelCadastro.addEventListener("change", () => {
  if (nivelCadastro.value === "Profissional") {
...
formCadastro.addEventListener("submit", async (event) => {
  ...
  const tipo_usuario = document.getElementById("nivelCadastro").value;
